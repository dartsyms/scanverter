...
extension Option {
    ...
    static let privacyValues: [InnerOptionValues] = [
        .init(title: "Location", isAddSection: true, isUseToggle: true, headerTitle: "ENABLE TO SHARE LOCATION"),
    ...
    static let mapsValues: [InnerOptionValues] = [
        ...
        .init(title: "Background App Refresh", isAddSection: true, isUseToggle: true, headerTitle: "ALLOW APPS TO REFRESH THEIR CONTENT IN BACKGROUND"),
    ...
    static let safariValues: [InnerOptionValues] = [
        ...
        .init(title: "Search Engine", isAddSection: false, isUseToggle: false, headerTitle: "SEARCH"),
    ...
    static let developerValues: [InnerOptionValues] = [
        .init(title: "DarkApperance", isAddSection: true, isUseToggle: true, headerTitle: "APPEARANCE"),
    ...
    static let options: [Option] = [
        ...
        .init(id: 8, title: "Developer", isAddSection: false, values: developerValues)
    ]
}
