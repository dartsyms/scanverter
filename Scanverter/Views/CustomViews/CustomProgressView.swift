...
public enum CustomProgressType {
    case loading
    case success
    case warning
    case error
...
public struct CustomProgressView: View {
    ...
    var config: CustomProgressConfig

    @Environment(\.colorScheme) private var colorScheme

    public init(_ isVisible: Binding<Bool>, config: CustomProgressConfig) {
    ...
    func generateHapticNotification(for type: CustomProgressType) {
